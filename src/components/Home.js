        ...
        <div className='home'>
            ...
            <div>
                <div className='personalView'>
                    ...
                    <p>Indiana raised, Indiana University Bloomington graduate. Studied for and obtained a bachelor's in Biology with a minor in Chemistry. Participated in after hours clubs and held formal head positions, such as Sectretary, Treasurer, and President of the IU J.A.C.C. After graduation, I spent a year gaining experience and working in a QA lab for Heritage Environmental, before moving on to work in sales to gain experience working with people.</p>
                    <p>Attended Eleven Fifty Academy to study JavaScript and C#/.Net. After studying in STEM fields and working in customer service, I realized that I wasn't working in a field that interested me, and decided to take time to figure out what did. Software development and design was something that caught my attention, as well as still allowed me to work along side the STEM fields I originally loved. Since December 2019, I have been able to put my software development and biology experience to use consulting for a healthcare data abstraction company.</p>
                </div>
            </div>
        </div>
    )
